...
pub fn infer_type(scope: &mut Vec<AbstractSyntaxTreeNode>) -> Result<(), Box<InferTypeError>> {
...
fn infer_type_rec(scope: &mut [AbstractSyntaxTreeNode], type_context: &mut StaticTypeContext) -> Result<(), Box<InferTypeError>> {
